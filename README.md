...
1. 레이블
    ...
    1. ~~수정내용 ==> 변경 요약  (버터 추가할때 "수정 내용"이란 말도 "발행 히스토리 내용"이런 말로 통일할까요?)~~
1. 기타
...
1. dirrty가 적용되는지?
1. ~~CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci; 와 utf8mb4_general_ci의 차이?~~
    - general은 한글 sorting이 안됨
1. dev 디비 지우고 다시 하는데, mysqldumb 불가
