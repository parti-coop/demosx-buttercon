...
public class SiteController {
    ...
    private List<WeakHashMap<String, String>> interviews = new ArrayList<>();

    public SiteController() {
        interviews.add(new WeakHashMap<String, String>() {
            {
                put("name", "노유진");
                put("org", "위커넥트 디렉터");
        ...
        interviews.add(new WeakHashMap<String, String>() {
            {
                ...
                put("org", "빠띠 민주주의 활동가");
                put("body",
                        "나의 경험으로 시작해, 세대의 경험을 모아내는 것. 우리 삶의 원칙이나 규율을 우리가 만드는 것. 함께 목소리를 모으고 행동하는 값진 경험이 우리 안에 남길 기대합니다.");
            }
        });
        interviews.add(new WeakHashMap<String, String>() {
            {
        ...
        interviews.add(new WeakHashMap<String, String>() {
            {
                ...
                put("body",
                        "우리의 문제는 우리가 제일 잘 알고, 그래서 우리가 가장 잘 해결할 수 있다고 믿습니다. 그리고 우리가 만드는 현재가 누군가에게 보다 나은 미래가 될 수 있기를 기대합니다.");
            }
        });
        interviews.add(new WeakHashMap<String, String>() {
            {
        ...
        interviews.add(new WeakHashMap<String, String>() {
            {
                ...
                put("body",
                        "정책을 만든다, 이렇게만 말하면 너무나도 어렵고 크게 느껴집니다. 하지만 내 삶의 어려움과 불편함에 노력을 통한 전문성 한 스푼이면 우리는 어떤 행정관, 국회의원보다도 좋은 정책을 만들어낼 수 있다고 생각합니다.");
            }
        });
        interviews.add(new WeakHashMap<String, String>() {
            {
                ...
                put("org", "뉴블랙 대표");
                put("body",
                        "이런 주제와 방식으로 이야기를 나눌 수 있는 시대가 오고 또 저에게 기회가 주어진 것에 굉장히 놀랍고 또 즐겁습니다. 다양성과 성평등을 기본으로 다양한 주제와  밀레니얼들의 새로운 관점을 통해 모두가 공감하고 고민해볼 수 있는 풍요로운 이야기들이 나왔으면 합니다.");
            }
        });
        interviews.add(new WeakHashMap<String, String>() {
            {
                ...
                put("org", "빌라선샤인 대표");
                put("body",
                        "이 시대를 살아가고 있는 우리의 경험이 정책을 만들고 미래를 만들어 가는데 필요한 최고의 전문성이라고 생각합니다. '우리-전문가'들이 만들어 갈 우리의 정책들을 기대합니다.");
            }
        });
    }
